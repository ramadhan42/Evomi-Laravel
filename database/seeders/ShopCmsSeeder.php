...
class ShopCmsSeeder extends Seeder
{
    ...
    {
        $id = [
            // ---- BELANJA (Figma: Koleksi Aroma Evomi + product grid) ----
            ['belanja', 'hero', 'headline_1', 'string', 'Koleksi'],
            ['belanja', 'hero', 'headline_1_color', 'string', '#5EA14A'],
            ['belanja', 'hero', 'headline_2', 'string', 'Aroma'],
            ['belanja', 'hero', 'headline_2_color', 'string', '#DD74A5'],
            ['belanja', 'hero', 'headline_3', 'string', 'Evomi'],
            ['belanja', 'hero', 'headline_3_color', 'string', '#1172BA'],
            ['belanja', 'hero', 'star_icon', 'image', '/src/images/belanja/deco/title-star.svg'],
            ...
            ['belanja', 'images', 'deco_purpose', 'image', '/src/images/belanja/deco/char-purpose.png'],
            ['belanja', 'images', 'deco_peaceful', 'image', '/src/images/belanja/deco/char-peaceful.webp'],
            ['belanja', 'images', 'deco_rebel', 'image', '/src/images/belanja/deco/char-rebel.png'],
            ['belanja', 'images', 'deco_sweet', 'image', '/src/images/belanja/deco/char-sweet.webp'],
            ['belanja', 'images', 'deco_gap_vertical_desktop', 'string', '80px'],
            ['belanja', 'images', 'deco_gap_horizontal_desktop', 'string', '12px'],
            ['belanja', 'images', 'deco_gap_vertical_mobile', 'string', '48px'],
            ['belanja', 'images', 'deco_gap_horizontal_mobile', 'string', '8px'],
            // Gambar + copy card (Figma BELANJA) — override product listing
            ['belanja', 'cards', 'card_purpose_image', 'image', '/src/images/belanja/cards/purpose.webp'],
            ['belanja', 'cards', 'card_peaceful_image', 'image', '/src/images/belanja/cards/peaceful.webp'],
            ['belanja', 'cards', 'card_rebel_image', 'image', '/src/images/belanja/cards/rebel.webp'],
            ['belanja', 'cards', 'card_sweet_image', 'image', '/src/images/belanja/cards/sweet.webp'],
            ['belanja', 'cards', 'card_purpose_title', 'string', 'Purpose Prestige'],
            ['belanja', 'cards', 'card_peaceful_title', 'string', 'Peaceful Calm'],
            ['belanja', 'cards', 'card_rebel_title', 'string', 'Rebel Brave'],
            ['belanja', 'cards', 'card_sweet_title', 'string', 'Sweet Shy'],
            ['belanja', 'cards', 'card_purpose_desc', 'text', 'Aroma yang merefleksikan ketenangan dan kejelasan tujuan.'],
            ['belanja', 'cards', 'card_peaceful_desc', 'text', 'Keberanian dan semangat untuk mengekspresikan diri.'],
            ['belanja', 'cards', 'card_rebel_desc', 'text', 'Aroma menenangkan yang menyatu dengan diri.'],
            ['belanja', 'cards', 'card_sweet_desc', 'text', 'Aroma menenangkan yang menyatu dengan diri.'],
            ['belanja', 'cards', 'card_purpose_price', 'string', 'Rp189.000'],
            ['belanja', 'cards', 'card_peaceful_price', 'string', 'Rp199.000'],
            ['belanja', 'cards', 'card_rebel_price', 'string', 'Rp179.000'],
            ['belanja', 'cards', 'card_sweet_price', 'string', 'Rp179.000'],
            ['belanja', 'cards', 'card_image_width_mobile', 'string', '170%'],
            ['belanja', 'cards', 'card_image_width_desktop', 'string', '185%'],
            ['belanja', 'cards', 'card_image_rotate_mobile', 'string', '30deg'],
            ['belanja', 'cards', 'card_image_rotate_desktop', 'string', '30deg'],
            ['belanja', 'cards', 'card_image_top_mobile', 'string', '46%'],
            ['belanja', 'cards', 'card_image_top_desktop', 'string', '42%'],
            ...
            ['belanja_details', 'shipping', 'ships_from_label', 'string', 'Dikirim dari'],
            ['belanja_details', 'shipping', 'origin_address', 'string', 'Cisauk'],
            ['belanja_details', 'shipping', 'free_shipping_label', 'string', 'Gratis Ongkir'],
            ...
            ['shipping', 'settings', 'free_shipping', 'string', '0'],
            ...
            ['checkout', 'labels', 'free_shipping', 'string', 'Gratis Ongkir'],
        ...
        $en = [
            ...
            ['belanja', 'cards', 'card_rebel_title', 'string', 'Rebel Brave'],
            ['belanja', 'cards', 'card_sweet_title', 'string', 'Sweet Shy'],
            ['belanja', 'cards', 'card_purpose_desc', 'text', 'A scent that reflects calm and clarity of purpose.'],
            ['belanja', 'cards', 'card_peaceful_desc', 'text', 'Courage and spirit to express yourself.'],
            ['belanja', 'cards', 'card_rebel_desc', 'text', 'A calming scent that blends with who you are.'],
            ['belanja', 'cards', 'card_sweet_desc', 'text', 'A calming scent that blends with who you are.'],
            ['belanja', 'cards', 'card_purpose_price', 'string', 'Rp189.000'],
            ['belanja', 'cards', 'card_peaceful_price', 'string', 'Rp199.000'],
            ['belanja', 'cards', 'card_rebel_price', 'string', 'Rp179.000'],
            ['belanja', 'cards', 'card_sweet_price', 'string', 'Rp179.000'],
            ...
            ['belanja_details', 'shipping', 'ships_from_label', 'string', 'Ships from'],
            ['belanja_details', 'shipping', 'origin_address', 'string', 'Cisauk'],
            ['belanja_details', 'shipping', 'free_shipping_label', 'string', 'Free Shipping'],
            ...
            ['checkout', 'labels', 'free_shipping', 'string', 'Free Shipping'],
